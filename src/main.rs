...
fn main() {
    ...
    let a = FieldElement::from_bytes(x, prime).unwrap();
    let b = FieldElement::from_bytes(y, prime).unwrap();

    println!("{:x}", a.get_number());
    println!("{:x}", b.get_number());
    println!("{}", a == b);
    println!("{:x}", (a.clone() + b.clone()).unwrap().get_number());
    println!("{:x}", (a.clone() * b.clone()).unwrap().get_number());
    println!("{:x}", (a.clone() - b.clone()).unwrap().get_number());
    println!("{:x}", (a.clone() - b.clone()).unwrap().get_number());
    ...
    let y = Point::new(
        Some(FieldElement::from_int(17, prime).unwrap()),
        Some(FieldElement::from_int(56, prime).unwrap()),
        a.clone(),
        b.clone(),
    );
    println!("{}", x);
    ...
    let z = Point::new(
        Some(FieldElement::from_int(15, prime).unwrap()),
        Some(FieldElement::from_int(86, prime).unwrap()),
        a.clone(),
        b.clone(),
    );
